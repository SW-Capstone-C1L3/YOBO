...
public class ShopLogData {
    public ShopLogData(String _id, List<ProductData> products,
                       Integer total_price, String transaction_status,
                       String user_Did, String user_address,
                       String user_id, String user_phone_num,
                       String company_id, String invoice_company,
                       String invoice_number, Timestamp timestamp) {
        this._id = _id;
